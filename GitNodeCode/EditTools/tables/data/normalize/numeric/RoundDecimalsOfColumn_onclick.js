var NumDecimals = prompt("Decimal places to round to?", "1");
    ...
    { var TDi=-1, TRi=-1;
       ...
       { var TRs = T.getElementsByTagName("TR");
         ...
         {  
            ...
            rep = orig.replace(/^[^0-9]*/, "").replace(/[^0-9]*$/, "");   /* trim */
            if (isNaN(rep) || rep.match(/^[ \t]*$/ ) ) rep=0;
            rep = parseFloat(rep).toFixed(NumDecimals);
